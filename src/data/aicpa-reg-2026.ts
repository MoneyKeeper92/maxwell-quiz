...
<p style="margin-left:0; margin-right:0">Look closely at <strong>who</strong> is assessing the penalty. If it is a government entity (federal, state, city, or local municipality), it is non-deductible and causes a book-tax difference. If it is a private organization (sports league, HOA, trade association, or corporate board), it is deductible and causes no difference.</p>
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation: `<div style="border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.1); font-family: Arial, Helvetica, sans-serif; overflow:hidden"><div style="background-color:#01506e; border-radius:8px 8px 0 0; color:white; padding:20px"><h1 style="color:white; margin:0">Bad Debt Expense: Book to Tax Reconciliation</h1></div><div style="background-color:white; padding:20px"><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Correct Answer</h3><p style="margin:0"><span style="color:#4caf50; font-weight:bold">✓</span> <span style="color:#4caf50; font-weight:bold">$2,000 is added back to book net income.</span></p></div><div style="background-color:#f0f7fa; border-left:5px solid #68d3a7; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Explanation</h3><p style="margin:0">Financial accounting and tax accounting use different methods for bad debts, and the reconciliation captures only the difference between them.</p><p style="margin:0">For book purposes the corporation uses the allowance method, estimating future credit losses and recording an expense of $27,000 this year.</p><p style="margin:0">For tax purposes the allowance method is not permitted. Section 166 requires the direct write-off method, so a corporation deducts a bad debt only in the year the specific receivable actually becomes worthless. Here that is the $25,000 of write-offs.</p></div><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Working the Adjustment</h3><p style="margin:0">Book income was reduced by the full $27,000 of estimated expense, but only $25,000 is deductible for tax.</p><ul style="margin:0 0 12px 0; padding-left:22px"><li style="margin:0 0 8px 0">Add back book bad debt expense: $27,000</li><li style="margin:0 0 8px 0">Deduct actual write-offs allowed for tax: $25,000</li><li style="margin:0 0 8px 0">Net adjustment: $2,000 added back to book net income</li></ul><p style="margin:0">Because the book deduction exceeded the tax deduction, taxable income must be higher than book income, so the difference is added back.</p></div><div style="background-color:white; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Analysis of Answer Options</h3><table cellspacing="0" style="border-collapse:collapse; margin-top:15px; width:100%"><thead><tr><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Option</th><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Analysis</th></tr></thead><tbody><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$2,000 is deducted from book net income</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This moves in the wrong direction. The book expense was larger than the tax deduction, so taxable income is higher than book income, not lower.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$25,000 is deducted from book net income</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. The write-offs are the amount tax allows, not the adjustment. Deducting them again would double count the tax deduction.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$27,000 is deducted from book net income</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This removes the entire book expense without substituting the $25,000 the tax law does allow.</td></tr></tbody></table></div><div style="background-color:#01506e; border-radius:0 0 8px 8px; color:white; padding:15px"><h3 style="color:white; margin:0 0 12px 0">Summary</h3><p style="margin:0">The reconciling item is the difference between the two methods: $27,000 of book expense less $25,000 of deductible write-offs, a $2,000 add-back. This is a temporary difference that reverses as the reserved accounts are actually written off.</p></div></div></div>`,
    },
    {
      id: "9565",
      ...
      correctIndex: 0,
      explanation: `<div style="border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.1); font-family: Arial, Helvetica, sans-serif; overflow:hidden"><div style="background-color:#01506e; border-radius:8px 8px 0 0; color:white; padding:20px"><h1 style="color:white; margin:0">Schedule M-3 Treatment of Limited Business Meals</h1></div><div style="background-color:white; padding:20px"><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Correct Answer</h3><p style="margin:0"><span style="color:#4caf50; font-weight:bold">✓</span> <span style="color:#4caf50; font-weight:bold">An entry of $100 is shown as a difference that is a book expense and not deductible.</span></p></div><div style="background-color:#f0f7fa; border-left:5px solid #68d3a7; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Explanation</h3><p style="margin:0">Business meals with a client are an ordinary and necessary business expense, so the full $200 is recorded as an expense for financial reporting. Section 274(n) limits the deduction to 50 percent of the cost, so only $100 is deductible on the tax return.</p><p style="margin:0">The reconciliation reports the gap between the two figures, not the whole expense.</p><ul style="margin:0 0 12px 0; padding-left:22px"><li style="margin:0 0 8px 0">Book expense: $200</li><li style="margin:0 0 8px 0">Tax deduction allowed: $100 (50 percent of $200)</li><li style="margin:0 0 8px 0">Difference reported on Schedule M-3: $100</li></ul><p style="margin:0">The $100 disallowed half is an expense on the books that the tax law never allows, in this year or any later year. That makes it a permanent difference, reported in the permanent difference column rather than the temporary one.</p></div><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Reading the Direction of the Difference</h3><p style="margin:0">Schedule M-3 distinguishes two directions, and picking the wrong one is the common error:</p><ul style="margin:0 0 12px 0; padding-left:22px"><li style="margin:0 0 8px 0">Expense on books, not deductible for tax: the book expense is larger, so taxable income exceeds book income</li><li style="margin:0 0 8px 0">Deduction for tax, not an expense on books: the tax deduction is larger, so taxable income is lower than book income</li></ul><p style="margin:0">Because half the meal cost is expensed for books but disallowed for tax, this is the first direction.</p></div><div style="background-color:white; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Analysis of Answer Options</h3><table cellspacing="0" style="border-collapse:collapse; margin-top:15px; width:100%"><thead><tr><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Option</th><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Analysis</th></tr></thead><tbody><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$100 as a deduction and not a book expense</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. The direction is reversed. The full $200 is a book expense; the issue is that half of it is not deductible, not that a deduction is missing from the books.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$200 as a book expense and not deductible</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This treats the entire meal as disallowed. Half the cost remains deductible under the 50 percent limit.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$200 as a deduction and not a book expense</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This is wrong on both counts: the amount overstates the difference and the direction is reversed.</td></tr></tbody></table></div><div style="background-color:#01506e; border-radius:0 0 8px 8px; color:white; padding:15px"><h3 style="color:white; margin:0 0 12px 0">Summary</h3><p style="margin:0">Only the disallowed half is a reconciling item. The $100 nondeductible portion is reported as a permanent difference: a book expense that is not deductible for tax.</p></div></div></div>`,
    },
    {
      id: "9566",
      ...
      correctIndex: 3,
      explanation: `<div style="border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.1); font-family: Arial, Helvetica, sans-serif; overflow:hidden"><div style="background-color:#01506e; border-radius:8px 8px 0 0; color:white; padding:20px"><h1 style="color:white; margin:0">Accrued Bonuses and the Two and One Half Month Rule</h1></div><div style="background-color:white; padding:20px"><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Correct Answer</h3><p style="margin:0"><span style="color:#4caf50; font-weight:bold">✓</span> <span style="color:#4caf50; font-weight:bold">$125,000 in year 4 and $75,000 in year 5.</span></p></div><div style="background-color:#f0f7fa; border-left:5px solid #68d3a7; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Explanation</h3><p style="margin:0">An accrual-basis employer normally deducts compensation in the year the all-events test is met and economic performance occurs. Here both conditions are satisfied at the end of year 4: the employees were officially notified and the amounts were fixed and determinable.</p><p style="margin:0">That is not the end of the analysis. When the recipient is a cash-basis employee, Section 267 and the deferred compensation rules add a timing test. Compensation paid within two and one half months after the close of the employer&#x27;s tax year is deductible in that year. Anything paid later is treated as deferred compensation and is deductible only in the year it is actually paid.</p></div><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Applying the Deadline</h3><p style="margin:0">The company is a calendar-year taxpayer, so year 4 closes on December 31, year 4. Two and one half months after that date is March 15, year 5.</p><ul style="margin:0 0 12px 0; padding-left:22px"><li style="margin:0 0 8px 0">$125,000 paid February 1, year 5: paid before March 15, so it is deductible in year 4</li><li style="margin:0 0 8px 0">$75,000 paid June 1, year 5: paid after March 15, so it is deductible in year 5</li></ul><p style="margin:0">The bonuses are therefore split across two tax years: $125,000 deducted in year 4 and $75,000 deducted in year 5.</p></div><div style="background-color:white; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Analysis of Answer Options</h3><table cellspacing="0" style="border-collapse:collapse; margin-top:15px; width:100%"><thead><tr><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Option</th><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Analysis</th></tr></thead><tbody><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$200,000 in year 4</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This ignores the deadline for the $75,000 paid in June, which falls outside the two and one half month window.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$200,000 in year 5</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. The $125,000 paid on February 1 met the deadline and belongs in year 4, so the whole amount cannot be pushed to year 5.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$125,000 in year 4 and $0 in year 5</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. The late payment is delayed, not lost. The $75,000 remains deductible, simply in the year it is paid.</td></tr></tbody></table></div><div style="background-color:#01506e; border-radius:0 0 8px 8px; color:white; padding:15px"><h3 style="color:white; margin:0 0 12px 0">Summary</h3><p style="margin:0">Accrual alone does not secure the deduction when the employee reports on the cash basis. Payment within two and one half months of year end keeps the deduction in the accrual year; payment after that date moves it to the year of payment.</p></div></div></div>`,
    },
    {
      id: "9567",
...
As a result of the IRS audit findings, what amount of taxable income should be reported on the year 3 tax return?`,
      ...
      correctIndex: 1,
      explanation: `<div style="border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.1); font-family: Arial, Helvetica, sans-serif; overflow:hidden"><div style="background-color:#01506e; border-radius:8px 8px 0 0; color:white; padding:20px"><h1 style="color:white; margin:0">Audit Adjustments Belong to the Year Under Examination</h1></div><div style="background-color:white; padding:20px"><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Correct Answer</h3><p style="margin:0"><span style="color:#4caf50; font-weight:bold">✓</span> <span style="color:#4caf50; font-weight:bold">$100,000</span></p></div><div style="background-color:#f0f7fa; border-left:5px solid #68d3a7; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Explanation</h3><p style="margin:0">Each tax year stands on its own. An adjustment arising from an examination is made to the return for the year it relates to, by amending or assessing that year. It does not roll forward into the next return the taxpayer happens to be filing.</p><p style="margin:0">The audit produced two findings, and both belong to closed years:</p><ul style="margin:0 0 12px 0; padding-left:22px"><li style="margin:0 0 8px 0">$10,000 of unreported income relates to year 1 and increases year 1 taxable income to $90,000</li><li style="margin:0 0 8px 0">$5,000 of additional deductions relates to year 2 and decreases year 2 taxable income to $45,000</li></ul><p style="margin:0">Neither figure touches year 3. The corporation earned $100,000 from operations in year 3, so $100,000 is the taxable income reported on the year 3 return.</p><p style="margin:0">Why the Timing of the Audit Does Not Matter</p><p style="margin:0">The findings surfaced before the year 3 return was filed, which is what makes the distractors tempting. The sequence of events is irrelevant. What governs is the year in which the income was earned or the expense incurred, not the year the error was discovered.</p></div><div style="background-color:white; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Analysis of Answer Options</h3><table cellspacing="0" style="border-collapse:collapse; margin-top:15px; width:100%"><thead><tr><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Option</th><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Analysis</th></tr></thead><tbody><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$95,000</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This pulls year 2&#x27;s additional $5,000 deduction into year 3. The deduction belongs to year 2.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$105,000</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This nets both adjustments into year 3, adding $10,000 and subtracting $5,000. Neither adjustment belongs there.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">$110,000</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This adds year 1&#x27;s unreported $10,000 to year 3 income. That income was earned in year 1 and is assessed against year 1.</td></tr></tbody></table></div><div style="background-color:#01506e; border-radius:0 0 8px 8px; color:white; padding:15px"><h3 style="color:white; margin:0 0 12px 0">Summary</h3><p style="margin:0">Year 3 taxable income is the $100,000 earned in year 3. The audit changes years 1 and 2 on their own returns and leaves year 3 untouched.</p></div></div></div>`,
    },
    {
      id: "9570",
...
<p style="margin-left:0; margin-right:0">Whenever a partnership pays off debt, the partners&#39; share of liabilities decreases. You must treat this reduction exactly the same as if the partnership handed the partner cash. <strong>A decrease in partnership debt = a deemed cash distribution = a reduction in outside basis.</strong></p>
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation: `<div style="border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.1); font-family: Arial, Helvetica, sans-serif; overflow:hidden"><div style="background-color:#01506e; border-radius:8px 8px 0 0; color:white; padding:20px"><h1 style="color:white; margin:0">Entity Classification Elections Available to an LLC</h1></div><div style="background-color:white; padding:20px"><div style="background-color:#f9f9f9; border-left:5px solid #0099d4; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Correct Answer</h3><p style="margin:0"><span style="color:#4caf50; font-weight:bold">✓</span> <span style="color:#4caf50; font-weight:bold">A trust.</span></p></div><div style="background-color:#f0f7fa; border-left:5px solid #68d3a7; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Explanation</h3><p style="margin:0">A limited liability company is created under state law and has no federal tax classification of its own. Classification comes from the check-the-box regulations, which treat an LLC as an eligible entity able to choose among a fixed set of classifications.</p><p style="margin:0">The choices available depend on the number of members:</p><ul style="margin:0 0 12px 0; padding-left:22px"><li style="margin:0 0 8px 0">An association taxable as a corporation, available to any LLC by election</li><li style="margin:0 0 8px 0">A partnership, the default for an LLC with two or more members</li><li style="margin:0 0 8px 0">An entity disregarded as separate from its owner, the default for a single-member LLC</li></ul><p style="margin:0">Trust classification is not on that list. A trust is not an eligible entity under the check-the-box regulations at all. Trust status describes a fiduciary arrangement in which a trustee holds and protects property for beneficiaries, rather than a joint business carried on for profit. Because an LLC is organized to conduct a business, it cannot elect to be taxed as a trust.</p></div><div style="background-color:white; border-radius:8px; margin-bottom:20px; padding:15px"><h3 style="color:#01506e; margin:0 0 12px 0">Analysis of Answer Options</h3><table cellspacing="0" style="border-collapse:collapse; margin-top:15px; width:100%"><thead><tr><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Option</th><th style="border-bottom:2px solid #01506e; padding:10px; text-align:left">Analysis</th></tr></thead><tbody><tr><td style="border-bottom:1px solid #dddddd; padding:10px">A partnership</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This is available, and is the default classification for an LLC with two or more members.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">An association</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This is available. Any LLC may elect to be treated as an association taxable as a corporation.</td></tr><tr><td style="border-bottom:1px solid #dddddd; padding:10px">An entity disregarded as separate from its owner</td><td style="border-bottom:1px solid #dddddd; padding:10px">Incorrect. This is available, and is the default for a single-member LLC.</td></tr></tbody></table></div><div style="background-color:#01506e; border-radius:0 0 8px 8px; color:white; padding:15px"><h3 style="color:white; margin:0 0 12px 0">Summary</h3><p style="margin:0">An LLC may be classified as a corporation, a partnership, or a disregarded entity. Trust classification is unavailable because a trust is a fiduciary arrangement rather than an eligible business entity.</p></div></div></div>`,
    },
    {
      id: "9545",
