...
<ul>
  <li>Beginning basis: $15,000</li>
  <li>Add ordinary income (40% of $300,000): $120,000</li>
  <li>Add separately stated capital gain (40% of $20,000): $8,000</li>
  <li>Subtract separately stated investment interest expense (40% of $5,000): $2,000</li>
  <li>Subtotal = $15,000 + $120,000 + $8,000 – $2,000 = $141,000</li>
  <li>Subtract distribution: $45,000</li>
  <li>Year-end basis = $141,000 – $45,000 = $96,000</li>
</ul>
<p>Wages do not affect S corporation stock basis.</p><div style="margin-top:1rem;padding:0.85rem 1rem;background:#fffbeb;border-left:4px solid #f59e0b;border-radius:6px"><strong>Key Concept</strong><p style="margin:0.4rem 0 0">Income and gains increase an S corporation shareholder's basis, while distributions and losses decrease basis. Separately stated items flow through based on ownership percentage.</p></div></div>`,
    },
    {
      id: "2",
...
<ul>
  <li>Initial contribution per partner: $150,000</li>
  <li>Share of nonrecourse debt ($600,000 total × 25% for each partner): $150,000</li>
  <li>Total so far: $150,000 + $150,000 = $300,000</li>
  <li>Add share of net income ($50,000 total × 25%): $12,500</li>
  <li>New total: $300,000 + $12,500 = $312,500</li>
  <li>Subtract share of capital loss ($20,000 total × 25%): $5,000</li>
  <li>Ending basis: $312,500 – $5,000 = $307,500</li>
</ul><div style="margin-top:1rem;padding:0.85rem 1rem;background:#fffbeb;border-left:4px solid #f59e0b;border-radius:6px"><strong>Key Concept</strong><p style="margin:0.4rem 0 0">A partner's basis includes their capital contributions, share of partnership liabilities, and income, reduced by distributions and losses.</p></div></div>`,
    },
    {
      id: "3",
...
<ul>
  <li>Initial basis: $10,000</li>
  <li>Share of unpaid partnership liability at year-end: 40% × $40,000 = $16,000</li>
  <li>Total basis available for losses: $10,000 + $16,000 = $26,000</li>
  <li>The partner's share of the total loss is 40% × $100,000 = $40,000</li>
  <li>However, loss deduction is limited to basis: $26,000</li>
</ul>
<p>The remaining $14,000 ($40,000 - $26,000) of loss is suspended and carried forward to future years.</p><div style="margin-top:1rem;padding:0.85rem 1rem;background:#fffbeb;border-left:4px solid #f59e0b;border-radius:6px"><strong>Key Concept</strong><p style="margin:0.4rem 0 0">Partnership losses are limited to a partner's basis. A partner's share of partnership debt increases their basis and therefore their loss limitation threshold.</p></div></div>`,
    },
    {
      id: "4",
...
<ul>
  <li>Long-term capital gain property donated to a public charity is generally deductible at fair market value (FMV)</li>
  <li>FMV of the sculpture: $100,000</li>
  <li>The deduction for such property is capped at 30% of AGI</li>
  <li>30% of $180,000 = $54,000</li>
</ul>
<p>That is the maximum allowable in the current year. The remaining $46,000 can be carried forward for up to 5 years.</p><div style="margin-top:1rem;padding:0.85rem 1rem;background:#fffbeb;border-left:4px solid #f59e0b;border-radius:6px"><strong>Key Concept</strong><p style="margin:0.4rem 0 0">Charitable contributions of long-term capital gain property to public charities are deductible at fair market value but limited to 30% of AGI. Excess contributions can be carried forward.</p></div></div>`,
    },
    {
      id: "5",
...
<ul>
  <li>Doctor and chiropractor fees: $6,000 (Deductible)</li>
  <li>Prescription glasses: $400 (Deductible)</li>
  <li>Elective cosmetic surgery: $8,000 (Not deductible - purely cosmetic with no medical necessity)</li>
  <li>Life insurance premium: $1,500 (Not deductible as a medical expense)</li>
</ul>
<p>Total deductible medical expenses before AGI limitation: $6,000 + $400 = $6,400</p>
<p>Note: After determining eligible expenses, they would be subject to the 7.5% of AGI floor.</p><div style="margin-top:1rem;padding:0.85rem 1rem;background:#fffbeb;border-left:4px solid #f59e0b;border-radius:6px"><strong>Key Concept</strong><p style="margin:0.4rem 0 0">Only qualified medical expenses are deductible. Cosmetic surgery and life insurance premiums generally don't qualify. Medical expenses must exceed 7.5% of AGI to be deductible.</p></div></div>`,
    },
    {
      id: "6",
...
<ul>
  ...
  <li>Plus improvements: $30,000</li>
  <li>Adjusted basis: $330,000</li>
  <li>Selling price: $400,000</li>
  <li>Realized gain: $400,000 - $330,000 = $70,000</li>
</ul>
...
<ul>
  <li>Gain from stocks (long-term): $8,000</li>
  <li>Loss from principal residence: $15,000 (Not deductible as a capital loss)</li>
  <li>Loss from corporate bonds (short-term): $12,000</li>
  <li>Loss from sculpture (long-term): $6,000</li>
</ul>
<p>Net capital position:</p>
<ul>
  <li>Net long-term: $8,000 - $6,000 = $2,000 gain</li>
  <li>Net short-term: $12,000 loss</li>
  <li>Overall net: $2,000 - $12,000 = $10,000 net capital loss</li>
</ul>
<p>Individuals can deduct up to $3,000 of net capital loss against ordinary income per year.</p>
<p>Loss carryforward: $10,000 - $3,000 = $7,000</p><div style="margin-top:1rem;padding:0.85rem 1rem;background:#fffbeb;border-left:4px solid #f59e0b;border-radius:6px"><strong>Key Concept</strong><p style="margin:0.4rem 0 0">Capital losses offset capital gains, and up to $3,000 of excess losses can offset ordinary income. Remaining losses are carried forward. Personal residence losses are not deductible.</p></div></div>`,
    },
    {
      id: "9",
...
<ul>
  <li>Total cost: $500,000</li>
  <li>Land value: $50,000 (Land is not depreciable)</li>
  <li>Depreciable basis: $450,000</li>
  <li>Under MACRS, nonresidential real property uses a 39-year recovery period</li>
  <li>Annual straight-line rate: $450,000 ÷ 39 = $11,538</li>
</ul>
<p>For nonresidential real property, MACRS uses mid-month convention:</p>
<ul>
  <li>Property placed in service in March (3rd month): 9.5 months of depreciation in Year 1</li>
  <li>Year 1 depreciation: $11,538 × (9.5 ÷ 12) = $9,139</li>
...
<ul>
  <li>Gross sales: $1,500,000</li>
  <li>Less: Cost of goods sold: $500,000</li>
  <li>Gross profit: $1,000,000</li>
  <li>Less: Operating expenses: $300,000</li>
  <li>Less: Guaranteed payments: $150,000</li>
  <li>Ordinary business income: $550,000</li>
</ul>
<p>Capital gains ($20,000) and portfolio interest income ($40,000) are separately stated items that are not included in ordinary business income. These amounts flow through to partners separately.</p><div style="margin-top:1rem;padding:0.85rem 1rem;background:#fffbeb;border-left:4px solid #f59e0b;border-radius:6px"><strong>Key Concept</strong><p style="margin:0.4rem 0 0">Partnership ordinary business income excludes separately stated items such as capital gains and portfolio income. Guaranteed payments to partners are deductible in calculating ordinary business income.</p></div></div>`,
    },
  ],
};
